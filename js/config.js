...
bookConfig.ShareButtonVisible = "Hide";    ////配置此处
...
bookConfig.backGroundImgURL = data.backImage?data.backImage:"./images/780.jpg";// 此处可定制 背景图 //配置此处
...
bookConfig.totalPageCount = data.pageCount;//配置此处
bookConfig.largePageWidth = data.width?data.width:"822";//配置此处
bookConfig.largePageHeight = data.height?data.height:"822";;//配置此处
bookConfig.bookTitle = data.title;
bookConfig.normalPath = data.imageUrl; //配置此处
bookConfig.largePath = data.imageUrl;  ////配置此处
bookConfig.thumbPath = data.imageUrl;  //配置此处
bookConfig.productName = data.title;
var language = [
  {
    language: "Chinese",
    btnFirstPage: "\u7b2c\u4e00\u9875",
